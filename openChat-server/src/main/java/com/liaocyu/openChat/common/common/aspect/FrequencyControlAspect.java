...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(com.liaocyu.openChat.common.common.annotation.FrequencyControl)||@annotation(com.liaocyu.openChat.common.common.annotation.FrequencyControlContainer)")
